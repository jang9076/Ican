...
function myrecipe(recipe_id,recipe_select) {
	...
	if(join_id==""){
		...
		$.post(url,{recipe_id:recipe_id,recipe_select:recipe_select,join_id:join_id},function(data){});
		alert("마이레시피 추가완료!");
		location.reload();
	}
            ...
            <div class="content">
                ...
                <div class="notice_search_area" style="border-top:none;padding-top: 20px;">
                    <ul class="recipe_tab" style="font-size: 16px; font-weight: bold; padding: 5px;">
                        <li class="on" style="border-right: solid 1px #ddd">
                ...
                <div class="notice_list_area">
							...
							<c:when test="${categoryId eq null}"> 
                                <c:forEach var="dto" items="${lists }">
		                          ...
		                          <li class="" style="height:auto">
		                         	...
		                         	<c:forEach var="dto2" items="${myrecipe}">
		                         	
		                                    <c:choose>
		                         			<c:when test="${dto.recipe_id eq dto2.recipe_id }">
		                         				<a href="#;" onclick="myrecipe('${dto.recipe_id}','${dto.recipe_select }');" class="receipe_on">찜</a>
		                         			</c:when>
		                         			
		                         			<c:when test="${dto.recipe_id ne dto2.recipe_id }">
		                         				<a href="#;" onclick="myrecipe('${dto.recipe_id}','${dto.recipe_select }');" class="receipe_off">찜</a>
		                         			</c:when>
		                           ...
		                           <c:if test="${join_id eq null }">
		                                      	...
		                                      	<a href="/dailychan/join/login.action" class="receipe_off">찜</a>
		                                      </c:if>
                  ...
                  <!-- //상품리스트 -->
                    ...
                    <form id="contentSearchForm">
                        ...
                        <input type="hidden" name="recipe_select"  value="${dto.recipe_select }" />
