...
<!--     <script src="https://connect.facebook.net/signals/config/291411411372810?v=2.8.47&amp;r=stable" async=""></script>
    ...
    <script charset="UTF-8" type="text/javascript" src="https://t1.daumcdn.net/postcode/api/core/190416/1555410100831/190416.js"></script>
...
<meta property="og:image" content="/images/etc/oasis_kakao.jpg">
	...
	<div id="header">
		...
		<div class="topPmBanner" style="background:#F0F4E6">
			<div class="tpb_in">
				<a href="/event/openPromotion/1">
					<img src="/images/common/top_openevent_banner.png" alt="">
				</a>
				<a href="#" class="tpbClose">
					<img src="/images/common/top_close.png" alt="상단 프로모션 닫기">
				</a>
			</div>
		</div>
		//top banner
		...
		<div class="header_area">
			...
			<div class="mypage_list_left">
				...
				<div class="h1_logo">
					<a href="/">
						<img src="/images/common/h1_logo.png" alt="OASiS">
					</a>
				</div>
				...
				<div class="searchBox">
					...
					<a href="#" onclick="searchProduct('keyword'); return false;">
						<img src="/images/common/gnbSearch.png" alt="검색">
					</a>
				</div>
...
<div class="gnb_area" id="gnbArea">
    <div class="contents">
                        ...
                        <li>
	                        ...
	                        <span class="first">
	                            <a href="#" onclick="javascript:categoryProducts(2); return false;">
	                                ...
	                                </li><li><a href="#" onclick="categoryProducts(9); return false;">주곡/잡곡</a></li>
                        ...
                        <li>
	                        ...
	                        <span class="first">
	                            <a href="#" onclick="javascript:categoryProducts(3); return false;">
	                                ...
	                                </li><li><a href="#" onclick="categoryProducts(16); return false;">닭/오리/유정란</a></li>
                        ...
                        <li>
	                        ...
	                        <span class="first">
	                            <a href="#" onclick="javascript:categoryProducts(4); return false;">
	                                ...
	                                </li><li><a href="#" onclick="categoryProducts(67); return false;">수산진미</a></li>
                        ...
                        <li>
	                        ...
	                        <span class="first">
	                            <a href="#" onclick="javascript:categoryProducts(7); return false;">
	                                ...
	                                </li><li><a href="#" onclick="categoryProducts(65); return false;">건강즙류</a></li>
                        ...
                        <li>
	                        ...
	                        <span class="first">
	                            <a href="#" onclick="javascript:categoryProducts(6); return false;">
	                                ...
	                                </li><li><a href="#" onclick="categoryProducts(30); return false;">참기름/오일류</a></li>
                        ...
                        <li>
	                        ...
	                        <span class="first">
	                            <a href="#" onclick="javascript:categoryProducts(5); return false;">
	                                ...
	                                </li><li><a href="#" onclick="categoryProducts(27); return false;">두유/우유/유제품</a></li>
                        ...
                        <li>
	                        ...
	                        <span class="first">
	                            <a href="#" onclick="javascript:categoryProducts(8); return false;">
	                                ...
	                                </li><li><a href="#" onclick="categoryProducts(37); return false;">천연염색침구/의류</a></li>
		...
		<script type="text/javascript">
			...
			cookieArray.push('1941-1745|/product/1941/thumb/thumb_1941a0001c62-1533-4165-b257-dbab8af144c0.jpg%7C%uB4DC%uBE48%uCE58%20%uC790%uC5F0%uBC29%uBAA9%uCE58%uC988%28270g%29%7C4900%7C3200');
			cookieArray.push('1946-1750|/product/1946/thumb/thumb_1946beb16a10-b54f-40f8-9b2b-640654ddeb06.jpg%7C%uB9E4%uC77C%20%uBC14%uC774%uC624%uD50C%uB808%uC778%28450g%29%7C3200%7C2050');
			cookieArray.push('2646-4545|/product/2646/thumb/thumb_2646d79c1e73-5983-4d66-98a2-6ff8a0b32f15.jpg%7C%3C4%uC6D4%20%uC815%uAE30Sale%uD2B9%uAC00%3E%uC81C%uC8FC%uCCAD%uC815%uC6B0%uC720%20900ml%7C4500%7C1500');
			cookieArray.push('3239-4679|/product/3239/thumb/thumb_3239286c28d5-d0c7-4dc3-9d72-c484e1951d01.jpg%7C%uC720%uAE30%uB18D%20%uC6A9%uCD94%uC300%20%uD604%uBBF8%20%284kg%29%7C19000%7C15200');
    ...
    <!-- reviewEventWrap -->
		<div class="reviewEventWrap">
			<div class="reviewEventCont top">
			   <a href="/myPage/commentList">
	               <img src="/dailychan/resources//images/promotion/review_event/review_event_top_0827.jpg">
	           </a>
	        </div>
	        
	        <!-- event01 -->
	        <div class="reviewEventCont reviewEvt1">
	        	<div class="eventContElement"><img src="/dailychan/resources//images/promotion/review_event/review_title_1.png"></div>
	        	<div class="eventContElement"><img src="/dailychan/resources//images/promotion/review_event/review_coupon.png"></div>
	        	<div class="eventContElement">
					<a href="/myPage/commentList">
						<img src="/dailychan/resources//images/promotion/review_event/review_btn_1.png">
					</a>
				</div>
	        </div>
	        <!-- event01 -->
	        ...
	        <div class="reviewEventCont reviewEvt2">
	        	<div class="eventContElement"><img src="/dailychan/resources//images/promotion/review_event/review_title_2.png"></div>
	        	<div class="eventContElement"><img src="/dailychan/resources//images/promotion/review_event/review_icons.png"></div>
	        	<div class="eventContElement">
					<a href="/myPage/commentList">
						<img src="/dailychan/resources//images/promotion/review_event/review_btn_1.png">
					</a>
