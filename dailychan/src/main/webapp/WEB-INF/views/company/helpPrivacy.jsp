			...
			<div class="content">
				...
				<div class="customerWrap">
					...
					<div class="cls_wrap">
	                    ...
	                    ② 데일리찬는 귀하의 개인정보보호를 매우 중요시하며, 『정보통신망이용촉진및정보보호에관한법률』상의 개인정보보 호규정 및 정보통신부가 제정한 『개인정보보호지침』을 준수하고 있습니다. 데일리찬는 개인정보보호정책을 통하여 귀하께서 제공하시는 개인정보가 어떠한 용도와 방식으로 이용되고 있으며 개인정보보호를 위해 어떠한 조치가 취해지고 있는지 알려드립니다.&nbsp;<br>
	                    ③ 데일리찬는 개인정보보호정책을 홈페이지 첫 화면에 공개함으로써 귀하께서 언제나 용이하게 보실 수 있도록 조치하고 있습니다.&nbsp;<br>
	                    ④ 데일리찬는 개인정보보호정책의 지속적인 개선을 위하여 개인정보보호정책을 개정하는데 필요한 절차를 정하고 있습니다. 그리고 개인정보보호정책을개정하는 경우 버전번호 등을 부여하여 개정된 사항을 귀하께서 쉽게 알아볼 수 있도록 하고 있습니다.&nbsp;
	                    <div class="subtit2 mgTop30">2. 개인정보의 수집범위</div>
	                    데일리찬는 회원님의 구매계약 이행을 위해 필요한 정보만을 수집합니다.&nbsp;<br>
	                    ...
	                    <div class="subtit2 mgTop30">3. 개인정보 수집에 대한 동의</div>
	                    데일리찬는 귀하께서 데일리찬의 개인정보보호방침 또는 이용약관의 내용에 대해 「동의함」버튼 또는 「동의안함」버튼을 클릭할 수 있는 절차를 &nbsp;마련하여, 「동의함」버튼을 클릭하면 개인정보 수집에 대해 동의한 것으로 봅니다.&nbsp;
	                    <div class="subtit2 mgTop30">4. 개인정보의 수집목적 및 이용목적</div>
	                    ① 데일리찬는 다음과 같은 목적을 위하여 개인정보를 수집하고 있습니다.<br>
	                    &nbsp;- 성명, 아이디, 비밀번호 : 서비스 이용에 따른 본인 식별 절차에 이용<br>
	                    &nbsp;- 이메일주소, 전화번호 : 고지사항 전달, 본인 의사 확인, 불만 처리 등 원활한 의사소통 경로의 확보, 새로운 서비스/신상품이나 이벤트 정보의 안내<br>
	                    ...
	                    <div class="subtit2 mgTop30">5. 쿠키에 의한 개인정보 수집</div>
	                    ① 쿠키(cookie)란? 데일리찬는 귀하에 대한 정보를 저장하고 수시로 찾아내는 '쿠키(cookie)'를 사용합니다. 쿠키는웹사이트가 귀하의 컴퓨터 브라우저(넷스케이프, 인터넷 익스플로러 등)로 전송하는 소량의 정보입니다. 귀하께서 웹사이트에 접속하면 ○○의 컴퓨터는 귀하의 브라우저에 있는 쿠키의 내용을 읽고, 귀하의 추가정보를 귀하의 컴퓨터에서 찾아 접속에 따른 성명 등의 추가 입력 없이 서비스를 제공할 수 있습니다. 쿠키는 귀하의 컴퓨터는 식별하지만귀하를 개인적으로 식별하지는 않습니다. 또한 귀하는 쿠키에 대한 선택권이 있습니다. 웹브라우저 상단의 도구 인터넷옵션 탭(option tab)에서 모든 쿠키를 다 받아들이거나, 쿠키가 설치될 때 통지를 보내도록 하거나, 아니면 모든 쿠키를 거부할 수 있는 선택권을 가질 수 있습니다.<br>
	                    ② 데일리찬의 쿠키(cookie) 운용 데일리찬는 이용자의 편의를 위하여 쿠키를 운영합니다. 데일리찬가 쿠키를 통해 수집하는 정보는 데일리찬 이용시 필요한 기본정보에 한하며, 그 외의 다른 정보는 수집하지 않습니다. 데일리찬가 쿠키(cookie)를 통해 수집한 회원 ID는 다음의 목적을 위해 사용됩니다.<br>
	                    ...
	                    <div class="subtit2 mgTop30">6. 목적외 사용 및 제3자에 대한 제공 및 공유</div>
	                    ① 데일리찬는 귀하의 개인정보를 「개인정보의 수집목적 및 이용목적」에서 고지한 범위내에서 사용하며, 동 범위를 초과하여 이용하거나 타인 또는 타기업기관에 제공하지 않습니다. 특히 다음의 경우는 주의를 기울여 개인정보를 이용 및 제공할 것입니다.<br>
	                    ...
	                    <div class="subtit2 mgTop30">7. 개인정보의 열람 · 정정</div>
	                    ...
	                    <div class="subtit2 mgTop30">8. 개인정보 수집, 이용, 제공에 대한 동의철회</div>
	                    ...
	                    ② 데일리찬는 개인정보의 수집에 대한 동의철회(회원탈퇴)를 개인정보를 수집하는 방법보다 쉽게 할 수 있도록 필요한 조치를 취하겠습니다.
	                    <div class="subtit2 mgTop30">9. 개인정보의 보유기간 및 이용기간</div>
	                    ...
	                    ② 귀하의 동의를 받아 보유하고 있는 거래정보 등을 귀하께서 열람을 요구하는 경우 데일리찬는 지체없이 그 열람, 확인 할 수 있도록 조치합니다.
	                    <div class="subtit2 mgTop30">10. 개인정보보호를 위한 기술 및 관리적 대책</div>
	                    ① 기술적 대책<br>
	                    데일리찬는 귀하의 개인정보를 취급함에 있어 개인정보가 분실, 도난, 누출, 변조 또는 훼손되지 않도록 안전성 확보를 위하여 다음과 같은 기술적 대책을 강구하고 있습니다.<br>
	                    &nbsp;- 귀하의 개인정보는 비밀번호에 의해 보호되며 파일 및 전송데이터를 암호화하거나 파일 잠금기능(Lock)을 사용하여 중요한 데이터는 별도의 보안기능을 통해 보호되고 있습니다.<br>
	                    &nbsp;- 데일리찬는 백신프로그램을 이용하여 컴퓨터바이러스에 의한 피해를 방지하기 위한 조치를 취하고 있습니다. 백신프로그램은 주기적으로 업데이트 되며 갑작스런 바이러스가 출현할 경우 백신이 나오는 즉시 이를 제공함으로써 개인정보가 침해되는 것을 방지하고 있습니다.<br>
	                    &nbsp;- 데일리찬는 암호알고리즘을 이용하여 네트워크 상의 개인정보를 안전하게 전송할 수 있는 보안장치(SSL 또는 SET)를 채택하고 있습니다.<br>
	                    &nbsp;- 해킹 등 외부침입에 대비하여 각 서버마다 침입차단시스템 및 취약점 분석시스템 등을 이용하여 보안에 만전을 기하고 있습니다.<br>
	                    ② 관리적 대책<br>
	                    데일리찬는 귀하의 개인정보에 대한 접근권한을 최소한의 인원으로 제한하고 있습니다. 그 최소한의 인원에 해당하는 자는 다음과 같습니다.<br>
	                    ...
	                    &nbsp; - 데일리찬는 이용자 개인의 실수나 기본적인 인터넷의 위험성 때문에 일어나는 일들에 대해 책임을 지지 않습니다. 회원 개개인이 본인의 개인정보를 보호하기 위해서 자신의 ID 와 비밀번호를 적절하게 관리하고 여기에 대한 책임을 져야 합니다.<br>
	                    &nbsp; - 그 외 내부 관리자의 실수나 기술관리 상의 사고로 인해 개인정보의 상실, 유출, 변조, 훼손이 유발될 경우 데일리찬는 즉각 귀하께 사실을 알리고 적절한 대책과 보상을 강구할 것입니다.
	                    <div class="subtit2 mgTop30">11. 링크사이트</div>
	                    데일리찬는 귀하께 다른 회사의 웹사이트 또는 자료에 대한 링크를 제공할 수 있습니다. 데일리찬가 경우 데일리찬는 외부사이트 및 자료에 대한 아무런 통제권이없으므로 그로부터 제공받는 서비스나 자료의 유용성에 대해 책임질 수 없으며 보증할 수 없습니다.
	                    <br>
	                    데일리찬가 포함하고 있는 링크를 클릭(click)하여 타 사이트(site)의 페이지로 옮겨갈 경우 해당 사이트의 개인정보보호정책은 데일리찬와 무관하므로 새로 방문한 사이트의 정책을 검토해 보시기 바랍니다.
	                    <div class="subtit2 mgTop30">12. 게시물</div>
	                    ① 데일리찬는 귀하의 게시물을 소중하게 생각하며 변조, 훼손, 삭제되지 않도록 최선을 다하여 보호합니다. 그러나 다음의 경우는 그렇지 아니합니다.<br>
	                    &nbsp;- 스팸(spam)성 게시물 (예 : 행운의 편지, 8억 메일, 특정사이트 광고 등)<br>
	                    &nbsp;- 타인을 비방할 목적으로 허위 사실을 유포하여 타인의 명예를 훼손하는 글<br>
	                    &nbsp;- 동의 없는 타인의 신상공개 데일리찬의 저작권, 제 3자의 저작권 등 권리를 침해하는 내용, 기타 게시판 주제와 다른 내용의 게시물<br>
	                    &nbsp;- 데일리찬는 바람직한 게시판 문화를 활성화하기 위하여 동의 없는 타인의 신상 공개시 특정부분을 삭제하거나 기호 등으로 수정하여 게시할 수 있습니다.<br>
	                    ...
	                    <div class="subtit2 mgTop30">13. 개인정보의 위탁처리</div>
	                    데일리찬는 서비스 향상을 위해서 귀하의 개인정보를 외부에 수집, 취급, 관리등을 위탁하여 처리할 수 있습니다.<br>
	                    ...
	                    <div class="subtit2 mgTop30">14. 이용자의 권리와 의무</div>
	                    ...
	                    <div class="subtit2 mgTop30">15. 의견수렴 및 불만처리</div>
	                    ① 당사는 귀하의 의견을 소중하게 생각하며 , 귀하는 의문사항으로부터 언제나 성실한 답변을 받을 권리가 있습니다.<br>
	                    ② 당사는 귀하와의 원활한 의사소통을 위해 고객센터를 운영하고 있습니다. 데일리찬 고객센터의 연락처는 다음과 같습니다.<br>
	                    【 고객센터 】<br>
	<!--                     &nbsp;- 전자우편 : customer@oasis.co.kr<br>
	                    &nbsp;(내용을 보내실 때 연락 가능한 전화, 휴대폰 번호를 적어 주시면 감사하겠습니다.)<br> -->
	                    &nbsp;- 전화번호 : 1577-0098 (09:00~18:00)<br>
	                    &nbsp;- 팩스번호 : 02-2155-5202<br>
	                    &nbsp;- 주 소 : &nbsp;서울시 서초구 강남대로 327 대륭서초타워 12층<br>
	                    ...
	                    <div class="subtit2 mgTop30">16. 개인정보관리책임자 및 담당자</div>
	                    데일리찬는 귀하가 좋은 정보를 안전하게 이용할 수 있도록 최선을 다하고 있습니다.&nbsp;<br>
	                    ...
	                    &nbsp; - 성 &nbsp; &nbsp; &nbsp;명 : 최우식<br>
	                    &nbsp; - 소속부서 : 기술담당<br>
	                    &nbsp; - 전자우편 : lskyjk@hanmail.net
	                    <div class="subtit2 mgTop30">17. 아동의 개인정보보호</div>
	                    데일리찬는 법정 대리인의 동의가 필요한 만 14 세 미만 아동의 회원 가입은 받고 있지 않습니다.
	                    <div class="subtit2 mgTop30">18. 광고성 정보 전송</div>
	                    ① 데일리찬는 귀하의 명시적인 수신거부의사에 반하여 영리목적의 광고성 정보를 전송하지 않습니다.<br>
	                    ② &nbsp;데일리찬는 귀하가 뉴스레터 등 전자우편 전송에 대한 동의를 한 경우 전자우편의 제목란 및 본문란에 다음 사항과 같이 귀하가 쉽게 알아 볼 수 있도록 조치합니다.<br>
	                    ...
	                    <div class="subtit2 mgTop30">19. 고지의 의무</div>
