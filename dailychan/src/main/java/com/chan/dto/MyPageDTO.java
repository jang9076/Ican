...
public class MyPageDTO {
	...
	public int getReviewCheck_check() {
		return reviewCheck_check;
	}
	public void setReviewCheck_check(int reviewCheck_check) {
		this.reviewCheck_check = reviewCheck_check;
	}
